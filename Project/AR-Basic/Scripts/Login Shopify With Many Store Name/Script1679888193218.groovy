...
WebUI.navigateToUrl(store_name + ".myshopify.com/admin")
...
for (String expectedText : expectedTexts) {
	WebUI.verifyElementPresent(findTestObject('Object Repository/Shopify/span_shopify_menu', ['text' : expectedText]),20,FailureHandling.CONTINUE_ON_FAILURE)
}

@com.kms.katalon.core.annotation.TearDownIfPassed
def teardownIfPassed() {
	String excelFilePath = 'Data Files\\StoreData\\AR-Basic_Store_Name.xlsx'
	CustomKeywords.'excelkeyword.excel.updateValueToSheet'(excelFilePath, "sheet1", 0, store_name, 1, 'Success')
}

@com.kms.katalon.core.annotation.TearDownIfFailed
def teardownIfFailed() {
	String excelFilePath = 'Data Files\\StoreData\\AR-Basic_Store_Name.xlsx'
	CustomKeywords.'excelkeyword.excel.updateValueToSheet'(excelFilePath, "sheet1", 0, store_name, 1, 'Fail')
}